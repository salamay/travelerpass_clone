              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: ListTile(
                      ...
                      title: Text("SIGN IN",style: GoogleFonts.lato(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                      subtitle: Text(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Already Signed in?",style: GoogleFonts.lato(
                        color: Colors.grey,
                      ),),
                      FlatButton(
                        onPressed: (){
                        ...
                        child:Text("Register now",style: GoogleFonts.lato(
                            color: Colors.pink,
                            fontSize: 18,
